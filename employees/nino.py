        ...
        try:
            ...
            for sig in active_signals:
                ...
                if (ticker_upper, sig_date_iso) not in existing_journal_set:
                    ...
                    print(f"Signal für {ticker_upper} erfolgreich archiviert und an aris_arbeitsspeicher übergeben.")
    ...
    def process_joris_journal(self):
        ...
        try:
            ...
            for item in joris_items:
                ...
                print(f"Joris-Journal Eintrag für {ticker_upper} ausgewertet und an aris_arbeitsspeicher übergeben.")
